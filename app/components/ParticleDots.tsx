...
export default function ParticleDots({
	...
	useEffect(() => {
		...
		if (svgPath) {
			...
			if (svgFit === "height") {
				effectiveScale = height / bbox.height;
			} else if (svgFit === "width") {
				effectiveScale = width / bbox.width;
			} else if (svgFit === "contain") {
				effectiveScale = Math.min(width / bbox.width, height / bbox.height);
			} else if (svgFit === "cover") {
				effectiveScale = Math.max(width / bbox.width, height / bbox.height);
			}
